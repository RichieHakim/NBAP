...
path_self, path_script, dir_save, dir_s2p, path_ws, path_cameraCSV, path_nwb, name_job, name_slurm, name_env = sys.argv


print(path_self, path_script, dir_save, dir_s2p, path_ws, path_cameraCSV, path_nwb, name_job, name_slurm, name_env)
...
params_template = {
    'paths': {
        ...
        'dir_s2p': dir_s2p,
        'path_ws': path_ws,
        'path_cameraCSV': path_cameraCSV,
        'path_faceRhythmNWB': path_nwb,
    },
